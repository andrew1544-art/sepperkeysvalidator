...
- 💾 **Auto-exports** working keys to `working_keys.txt` pre-formatted for `.env`
...
══════════════════════════════════════════════════════════════
  ...
  SERPER_API_KEYS=0cb6ada6...,be91589e...,783993fe...

  Also saved to: working_keys.txt
...
After each run, `working_keys.txt` is written automatically:
...
Copy the `SERPER_API_KEYS=` line straight into your `.env` file.
